...
지원자께서 삭제를 요청하실 경우 해당 개인정보는 삭제됩니다.
        ...
        <div class="apply">
            <label><input type="radio" name="agree0" checked><i class="ico-radio-circleCheckRed"></i> 동의합니다</label>
            <label><input type="radio" name="agree0"><i class="ico-radio-circleCheckRed"></i> 동의안함</label>
        </div>
    </div>
    <!-- // 약관모듈 -->
