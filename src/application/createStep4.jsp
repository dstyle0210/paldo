...
String cDep3 = "입사지원서 확인"; // 3depth명 (없을경우 공백으로 처리 EX: "" )
%>
    ...
    <div class="createWriteSec">
            ...
            <div class="wall-default">
                <div class="board-write">
                    <table>
                        <tr>
                            <td>
                                <div class="row"><span class="form-label">경력</span></div>
                                <div class="row">
                                    <span class="form-label">1지망</span>
                                    <span class="form-label">국내영업</span>
                                    <span class="form-label">2지망</span>
                                    <span class="form-label">해외영업</span>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <div class="wall-profile">
                <div class="board-write">
                    <table>
                        ...
                        <tr>
                            <th>생년월일</th>
                            <td colspan="3">1980-01-01</td>
                            <th>나이</th>
                            <td colspan="3">만 30세</td>
                        </tr>
                        <tr>
                            <th>휴대전화</th>
                        ...
                        <tr>
                            <th>Email</th>
                            <td colspan="7">honggildong@naver.com</td>
                        </tr>
                        <tr>
                            <th>주소</th>
                            <td colspan="7">
                                <p>12345</p>
                                <p>서울특별시 서초구 강남대로 577</p>
                                <p>우덕빌딩</p>
                            </td>
                        </tr>
                        <tr>
                            <th>페이스북</th>
                            <td colspan="7">http://www.facebook.com/honggildong</td>
                        </tr>
                        <tr>
                            <th>트위터</th>
                            <td colspan="7">http://www.twitter.com/honggildong</td>
                        </tr>
                        <tr>
                            <th>블로그</th>
                            <td colspan="7">http://blog.naver.com/honggildong</td>
                        </tr>
                        <tr>
                            <th>취미/특기</th>
                            <td colspan="7">컴퓨터 / 노래</td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="btnSec">
            <div class="btn-sec-center">
                <a href="#" class="btn-lg btn-edit"><span>수정하기</span></a>
                <a href="../application/createSuccess.jsp" class="btn-lg btn-submit"><span>지원하기</span></a>
            </div>
        </div>
