...
<div class="pageWrap applicationWrap" id="applicationPass">
    ...
    <div class="passResultSec">
        <h3 class="failH3">2017 팔도 신입/경력 사원 채용 <b class="text-darkgray">합격자 명단에 없습니다.</b></h3>
        <div class="failResult">
            <p>안녕하세요. <b>홍길동</b>님 팔도 채용담당자입니다.<br/>이번 <b class="text-point">2017 팔도 신입/경력 사원 채용</b>에 서류전형에 응시해주셔서 감사합니다.</p>
        ...
        <div class="recrultResultImg">
            <img src="../images/temp/@resultFail.jpg" alt="">
        </div>
    </div>
</div>
