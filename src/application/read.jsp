...
String cDep2 = "지원서 조회"; // 2depth명 (없을경우 공백으로 처리 EX: "" )
String cDep3 = "계정조회"; // 3depth명 (없을경우 공백으로 처리 EX: "" )
%>
<%@ include file="../include/header.jsp" %>

<div class="pageWrap applicationWrap" id="applicationRead">
    <h2 class="createH2">지원서 조회</h2>
    <div class="createWriteSec">
        ...
        <div class="btnSec">
            <div class="btn-sec-center">
                <a href="../application/createStep4.jsp" class="btn-lg btn-submit"><span>조회</span></a>
            </div>
        </div>
